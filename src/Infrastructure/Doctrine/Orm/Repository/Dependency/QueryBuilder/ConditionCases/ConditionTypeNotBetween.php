...
class ConditionTypeNotBetween extends DefaultBetweenCondition implements ConditionTypeCaseInterface
{
    public function isCanBeProcessed(Condition $condition): bool
    {
        return $condition->getType() === ConditionTypeEnum::NOT_BETWEEN;
    }
