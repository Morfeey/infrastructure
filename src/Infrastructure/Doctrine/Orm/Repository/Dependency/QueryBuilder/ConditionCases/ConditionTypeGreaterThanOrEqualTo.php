...
class ConditionTypeGreaterThanOrEqualTo extends DefaultConditionType implements ConditionTypeCaseInterface
{

    public function isCanBeProcessed(Condition $condition): bool
    {
        return $condition->getType() === ConditionTypeEnum::GREATER_THAN_OR_EQUAL_TO;
    }
